...
function js_beautify(js_source_text, options) {
    ...
    var wanted_newline, just_added_newline, n_newlines, wrapped, wanted_space;
    ...
    while (true) {
        ...
        case 'TK_OPERATOR':
            ...
            wanted_space = wanted_space || space_before;
            print_token();
            wanted_space = space_after;
            break;
